  ...
  return (
    ...
    <div className='min-h-screen  flex flex-col justify-center px-4 bg-[#f4f4f462] '>
        ...
        <form   className='grid grid-cols-1 gap-4 text-black relative bottom-8 mx-4   lg:text-lg'>
            ...
            <p onClick={()=> setBloque(!bloque)} className='mx-10 rounded-sm text-white font-medium text-center bg-gradient-to-r from-[#088cb4] to-[#f7941d]  py-2 px-4  shadow-md shadow-gray-300 hover:scale-105 hover:from-[#f7941d] hover:to-[#088cb4] cursor-pointer'> {bloque ? 'Retour' : 'Compléter ou modifier '}</p>
            {bloque && (
